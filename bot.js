...
async function sendDmWelcome(user) {
  const caption = `Salut ${escapeMarkdown(user.first_name)} 🚀 Ton accès VIP t'attend  Mais attention, les opportunités ne se présentent qu’aux audacieux. 💪 clic vite sur le bouton ci-dessous pour debloquer ton acces 👇👇.`;
  try {
